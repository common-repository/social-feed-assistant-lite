...
class WpsfStreamClassicTemplateHandler extends WpsfStreamTemplatesPresenterHandler
{
    public static $count;
    ...
    {
        ob_start();
        include self::$baseView . DIRECTORY_SEPARATOR . 'shortcodes' . DIRECTORY_SEPARATOR . 'wpsf' . DIRECTORY_SEPARATOR . 'templates' . DIRECTORY_SEPARATOR . 'classic' . DIRECTORY_SEPARATOR . 'masonry.php';
        return str_replace("\r\n", '', ob_get_clean());
    }
