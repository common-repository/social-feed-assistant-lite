...
class SfalStreamNormalizerUtil
{
    /**
    ...
    {
        return (string) SfalCarbon::createFromTimestamp($timestamp)->format('F j');    
    }
    ...
    {
        return (string) SfalCarbon::createFromTimestamp($timestamp)->diffForHumans();
    }
    ...
    {
        return (string) SfalCarbon::createFromTimestamp($timestamp)->toFormattedDateString();
    }
