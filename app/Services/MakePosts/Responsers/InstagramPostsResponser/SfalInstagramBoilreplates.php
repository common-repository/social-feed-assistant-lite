...
class SfalInstagramBoilreplates
{
     ...
     * @return void
     */
    public static function postBoilreplate(Media $post, array $user, int $feedId, int $contentId)
    {
        $b = [
            'feed_id'      => $feedId,
            'feed_content' => $contentId,
     ...
     * @return array
     */
    public static function commentBoilreplate(Comment $comment, string $postId, int $feedId, int $contentId) : array
    {
        return [
            'feed_id'         => $feedId,
            'feed_content'    => $contentId,
