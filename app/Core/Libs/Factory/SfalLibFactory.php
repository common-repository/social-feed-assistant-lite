...
namespace SFAL\Core\Libs\Factory;

defined('ABSPATH') || exit('no access');

use SFAL\Core\Libs\Validator\SfalValidator;

class SfalLibFactory
{
    private static $alias = [
        'validator' => SfalValidator::class
    ];
    private static $libs = [];
    ...
    private static function resolveLib($lib)
    {
        ...
        self::hasLib($lib) || self::storeLib($lib);
