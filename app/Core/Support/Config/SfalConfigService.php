...
namespace SFAL\Core\Support\Config;

use SFAL\Core\Foundation\Contracts\SfalConfigContract;

defined('ABSPATH') || exit('no access');

final class SfalConfigService implements SfalConfigContract
{
     ...
     * @param  string  $file
     *
     * @return \SFAL\Core\Support\Config\SfalConfig
     */
    private function loadConfig(string $file)
    {
        $content = $this->read($file);

        return (null !== $content) ? new SfalConfig($content) : null;
    }

    /**
     * @param  string  $name
     *
     * @return \SFAL\Core\Support\Config\SfalConfig|mixed|null
     */
