...
namespace SFAL\Core\Support\Assets;

defined('ABSPATH') || exit('no access');

final class SfalAssetsLoader
{
     ...
     * @param  mixed  $prefix
     *
     * @return \SFAL\Core\Support\Assets\SfalAssetsLoader
     */
    ...
    public static function getInstance(string $prefix = 'sfal')
    {
