<div class="sfal-tab-content-header">
    <span class="sfal-tab-content-title"><?php _e('Create Feed', 'wp-ss') ?></span>
    <span class="sfal-tab-content-description"><?php _e('Create new feed and use on stream widgets', 'wp-ss') ?></span>
    <a class="sfal-back-page" sfal-get-back><i class="lni-arrow-left"></i>
		<?php _e('Feeds List', 'wp-ss') ?></a>
</div>
<div class="sfal-tab-content-main">
    <form class="sfal-create-feed-form" method="get" action="<?php echo esc_url(admin_url('admin-ajax.php')) ?>">
        <div class="sfal-create-feed-form-content sfal-form-content clearfix">
            <div class="sfal-form-input" style="visibility: hidden">
                <input type="hidden" name="action" value="sfal_new_feed"/>
            </div>
            ...
            <div class="sfal-setting-row-content">
                <div class="sfal-form-input">
                    <input type="text" name="name" placeholder="<?php _e('Choose a name', 'wp-ss') ?>"/>
                </div>
            </div>
                        ...
                        <?php foreach ($socials as $social) : ?>
                            <div class="pretty p-default p-round">
                                <input name="social-type" class="sfal-create-feed-stype-input" type="radio"
                                    value="<?php echo esc_attr($social->id) ?>">
                        ...
                        <select name="account" id="sfal-create-feed-account-input">
                                <?php foreach ($accounts as $account) : ?>
                                    <option data-social="<?php echo esc_attr($account->social_type) ?>"
                                            ...
                                            id="sfal-create-feed-account-option-<?php echo esc_attr($account->id) ?>"><?php echo esc_html($account->title) ?></option>
                                <?php endforeach; ?>
                        </select>
                    </div>
                </div>
			...
			<?php wp_nonce_field('sfal-new-feed', 'save-feed-nonce'); ?>
        </div>
        <div class="sfal-create-feed-form-footer sfal-form-footer">
