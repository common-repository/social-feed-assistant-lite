<li tab-content="sfal-create-stream-shortcode-tab">
    ...
    <div class="sfal-tab-content-main">
        ...
        <div class="sfal-create-stream-shortcode">
            <span class="sfal-create-stream-shortcode-copy-trigger" data-clipboard-text='[wp-sfstream id="<?php echo isset($afterAutoIncreament) ? esc_attr($afterAutoIncreament) : '1' ?>"]'>
                <span class="sfal-create-stream-shortcode-copy-status">Click to copy</span>
                <span class="sfal-create-stream-shortcode-value">[wp-sfstream id="<?php echo isset($afterAutoIncreament) ? esc_attr($afterAutoIncreament) : '1' ?>"]</span>
            </span>
        </div>
