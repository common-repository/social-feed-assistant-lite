    ...
    <div class="sfal-setting-row clearfix">
        ...
        <div class="sfal-template-selector-container">
            <ul class="sfal-create-stream-template-selector">
                <li>
                    <span <?php echo esc_attr($stream->options->general->postSettings->template) == 'tile' ? "class='active-template'" : null ?> data-template="tile"> <i class="skeleton-tile"></i> Tile </span>
                </li>
                <li>
                    <span <?php echo esc_attr($stream->options->general->postSettings->template) == 'classic' ? "class='active-template'" : null ?> data-template="classic"> <i class="skeleton-classic"></i> Classic </span>
                </li>
            </ul>
        </div>
    ...
    <div class="sfal-setting-row clearfix">
        ...
        <div class="sfal-layout-selector-container">
            <ul class="sfal-create-stream-layout-selector">
                ...
                <li data-content="sfal-create-stream-masonry-layout-settings">
                    <span <?php echo esc_attr($stream->options->general->postSettings->layout) == 'masonry' ? "class='active-layout'" : null ?> data-label="masonry"><i class="sprite-masonry"></i> Masonry </span>
                </li>
    ...
    <div class="sfal-setting-row sfal-border-btm-none clearfix">
        <div class="sfal-layout-content">
            <ul class="sfal-create-stream-layout-settings">
                ...
                <li data-content="sfal-create-stream-masonry-layout-settings"
                    class=" <?php echo esc_attr($stream->options->general->postSettings->layout) == 'masonry' ? 'active-layout-content' : null ?> clearfix">
                    ...
                    <div class="sfal-setting-row-content sfal-device-list">
                        ...
                        <div>
                            ...
                            <div class="range-slider">
                                <input class="range-slider__range" type="range"
                                       value="<?php echo esc_attr($stream->options->masonry->responsive->desktop->column) ?>"
                                       min="1" max="12"
                            ...
                            columns with <input class="sfal-extra-small" type="number"
                                                min="0"
                                                value="<?php echo esc_attr($stream->options->masonry->responsive->desktop->gap) ?>"
                        ...
                        <div>
                            ...
                            <div class="range-slider">
                                <input class="range-slider__range" type="range"
                                       value="<?php echo esc_attr($stream->options->masonry->responsive->tablet->column) ?>"
                                       min="1" max="12"
                            ...
                            columns with <input class="sfal-extra-small" type="number"
                                                min="0"
                                                value="<?php echo esc_attr($stream->options->masonry->responsive->tablet->gap) ?>"
                        ...
                        <div>
                            ...
                            <div class="range-slider">
                                <input class="range-slider__range" type="range"
                                       value="<?php echo esc_attr($stream->options->masonry->responsive->mobile->column) ?>"
                                       min="1" max="12"
                            ...
                            columns with <input class="sfal-extra-small" type="number"
                                                min="0"
                                                value="<?php echo esc_attr($stream->options->masonry->responsive->mobile->gap) ?>"
